...
interface DataFetchingDelegate {
    fun fetchBrowsingData(loadingAction: () -> Unit, viewModel: BrowseViewModel, onSuccess: Observable<MutableList<BannerModel>>.() -> Unit, onFailure: () -> Unit)
}
